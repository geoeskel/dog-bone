...
#   Django auth decorator, checking if the user is logged in
@login_required
def add_product(request):
    #   Add a product to the store
    #   Only superusers will have access to add/update/delete products
    if not request.user.is_superuser:
        messages.error(request, 'Only the owner can do that. Are you lost?')
